  ...
  return (
    <div className="Burger-total">
      <div className="Burger-menu">
        <button className="btn-break">
          <div className="circle">
            <img className="burgerdoble" src={btnsandwich} />
          </div>
        ...
        <button className="btn-break">
          <div className="circle">
            <img className="burgerdoble" src={btncoffe} />
          </div>
      ...
      <div className="Burger-menubreak">
        <button className="btn-break">
          <div className="circle">
            <img className="burgerdoble" src={btnbtnjuice} />
          </div>
        ...
        <button className="btn-break">
          <div className="circle">
            <img className="burgerdoble" src={btnmilkcoffe} />
          </div>
